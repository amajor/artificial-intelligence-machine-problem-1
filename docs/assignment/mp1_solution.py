...
01/27/2019; revised 09/12/2021 by Bo Xu
Fall 1, 2021
Machine Problem 1
...
class PuzzleState():
    ...
    def gen_next_state(self, direction):
        ...
        if direction=='up':
            next_puzzle[self.zeroloc[0]][self.zeroloc[1]] = next_puzzle[self.zeroloc[0] - 1][self.zeroloc[1]]
            next_puzzle[self.zeroloc[0] - 1, self.zeroloc[1]] = 0
        elif direction=='down':
            next_puzzle[self.zeroloc[0]][self.zeroloc[1]] = next_puzzle[self.zeroloc[0] + 1][self.zeroloc[1]]
            next_puzzle[self.zeroloc[0] + 1, self.zeroloc[1]] = 0
        elif direction=='left':
            next_puzzle[self.zeroloc[0]][self.zeroloc[1]] = next_puzzle[self.zeroloc[0]][self.zeroloc[1] - 1]
